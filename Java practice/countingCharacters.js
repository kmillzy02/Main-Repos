...
function countingCharacters2(stringToCount, characterToFind){
    ...
    for (var characterPosition = 0;
        ...
        console.log("sString to search in: " + stringToCount);
        console.log("charactoer to find: " + characterToFind);
        console.log("nNumber of times the character appears: " + characterCount);
}
